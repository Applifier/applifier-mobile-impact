...
extern "C" {
	...
	bool showImpact (bool openAnimated, bool noOfferscreen, const char *gamerSID) {
        NSLog(@"showImpact");
        NSDictionary *props = @{kApplifierImpactOptionGamerSIDKey: gamerSID, kApplifierImpactOptionNoOfferscreenKey: noOfferscreen, kApplifierImpactOptionOpenAnimatedKey: openAnimated};
	...
	char* getSDKVersion () {
        NSLog(@"getSDKVersion");
        return [[ApplifierImpact getSDKVersion] UTF8String];
    }
	...
	char* getDefaultRewardItemKey () {
        ...
        return [[[ApplifierImpact sharedInstance] getDefaultRewardItemKey] UTF8String];
    }
	
	char* getCurrentRewardItemKey () {
        NSLog(@"getCurrentRewardItemKey");
        return [[[ApplifierImpact sharedInstance] getCurrentRewardItemKey] UTF8String];
    }
