...
- (void)openImpact {
    ...
    if ([[ApplifierImpact sharedInstance] canShowImpact]) {
        ...
        NSLog(@"showImpact: %i", [[ApplifierImpact sharedInstance] showImpact:@{kApplifierImpactOptionNoOfferscreenKey:@YES, kApplifierImpactOptionOpenAnimatedKey:@true, kApplifierImpactOptionGamerSIDKey:@"gom", kApplifierImpactOptionMuteVideoSounds:@NO, kApplifierImpactOptionVideoUsesDeviceOrientation:@false}]);
