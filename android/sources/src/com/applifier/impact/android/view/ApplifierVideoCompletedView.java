...
public class ApplifierVideoCompletedView extends FrameLayout {

	public ApplifierVideoCompletedView(Context context) {
		super(context);
		createView();		
	}

	public ApplifierVideoCompletedView(Context context, AttributeSet attrs) {
		super(context, attrs);
		createView();
	}
